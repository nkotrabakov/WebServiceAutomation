...
namespace WebServiceAutomation.PutEndPoint
{
    ...
    public class TestPutEndPoint
    {
        ...
        public void TestPutUsingXmlData()
        {
            ...
            Assert.IsTrue(xmlObj.Features.Feature.Contains("1TB SSD"), "Item not found");
        }
        ...
        public void TestPutUsingJsonData()
        {
            ...
            Assert.IsTrue(jsonObject.Features.Feature.Contains("1TB SSD"), "Item not found");
        }
        ...
        public void TestPutWithHelperClass_Json()
        {
            ...
            restResponse = HttpClientHelper.PerformPostRequest(postUrl, jsonData, jsonMediaType, httpHeaders);
            ...
            restResponse = HttpClientHelper.PerformPutRequest(putUrl, jsonData, jsonMediaType, httpHeaders);
            Assert.AreEqual(200, restResponse.StatusCode);
        ...
        public void TestPutWithHelperClass_Xml()
        {
            ...
            restResponse = HttpClientHelper.PerformPutRequest(putUrl, xmlData, xmlMediaType, httpHeaders);
            Assert.AreEqual(200, restResponse.StatusCode);
        ...
        public void TestSecurePutEndPoint()
        {
            ...
            restResponse = HttpClientHelper.PerformPutRequest(securePutUrl, xmlData, xmlMediaType, httpHeaders);
            Assert.AreEqual(200, restResponse.StatusCode);
